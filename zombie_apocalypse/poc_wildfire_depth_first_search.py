...
class WildFire(poc_grid.Grid):
    ...
    def __init__(self, grid_height, grid_width, stack=poc_stack.Stack()):
        """
        Override initializer for Grid, add queue to store boundary of fire
        """
        poc_grid.Grid.__init__(self, grid_height, grid_width)
        self._fire_boundary = stack
    ...
    def update_boundary(self):
        ...
        for neighbor in neighbors:
            if self.is_empty(neighbor[0], neighbor[1]):
                ...
                self._fire_boundary.push(neighbor)
